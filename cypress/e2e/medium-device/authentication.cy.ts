...
describe('Authentication', () => {
  ...
  context('Medium device', () => {
    ...
    it('[AUTH-6] Verify login page content', () => {
      loginPage
    ...
    it('[AUTH-7] Should verify auth validation', () => {
    ...
    it('[AUTH-8] Should login with standard user', () => {
      username = credentials.username[0];
    ...
    it('[AUTH-9] Should not login with locked user', () => {
    ...
    it('[AUTH-10] Should login with problem user', () => {
